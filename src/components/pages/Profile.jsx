          ...
          <Card>
            <div className="p-6 text-center">
              <div className="relative inline-block mb-6">
                <div className="w-32 h-32 bg-gradient-to-r from-primary-500 to-secondary-500 rounded-full flex items-center justify-center text-white text-4xl font-bold mx-auto">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  ...
                  {isEditing ? (
                    ...
                    <p className="text-gray-900 font-medium">{profile.guardianName}</p>
                  )}
                </div>
                ...
                <div>
                  ...
                  {isEditing ? (
                    ...
                    <p className="text-gray-900 font-medium">{profile.guardianPhone}</p>
                  )}
                </div>
                ...
                <div>
                  ...
                  {isEditing ? (
                    ...
                    <p className="text-gray-900 font-medium">{profile.guardianEmail}</p>
                  )}
                </div>
              </div>
            </div>
